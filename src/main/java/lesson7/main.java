...
public class main {
    ...
    public static void main(String[] args) {
        ...
        Cat[] cat = new Cat[3];
        cat[0] = new Cat("Кузьма", 150, 3);
        cat[1] = new Cat("Кыс", 100, 4);
        cat[2] = new Cat("Петушок", 30, 1);
        Plate plate = new Plate(700);
        System.out.println("Привет! есть три кота: " + cat[0].getName() + ", " + cat[1].getName() + " и " + cat[2].getName() + ", которые хотят есть каждые " + cat[0].getSatietyTime() + ", " + cat[1].getSatietyTime() + " и " + cat[2].getSatietyTime() + " час(а) соответственно.");
        System.out.println("Кто-то из них более прожорлив. Сейчас в миске " + plate.getFood() + " грамм корма. Насколько его хватит.\n");
